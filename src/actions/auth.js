...
export const LOGIN_VK = 'redux-example/auth/LOGIN_VK';
export const LOGIN_VK_SUCCESS = 'redux-example/auth/LOGIN_VK_SUCCESS';
export const LOGIN_VK_FAIL = 'redux-example/auth/LOGIN_VK_FAIL';
